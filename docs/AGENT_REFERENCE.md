# QBO Timesheet implementation reference

Read the sections relevant to the task, as routed by AGENTS.md. Provider API notes
are historical implementation evidence; verify current official documentation and
the actual request code before changing an API integration.
